	...
	getLogData = (user, pass) => {
		try {
			for (let i = 0; i < this.props.usuarios.length; i++) {
				if (
					this.props.usuarios[i].nombre == user &&
					this.props.usuarios[i].password == pass
				) {
					return this.props.usuarios[i];
				}
			}
		} catch (error) {
			console.error(`Error fatal trayendo los datos del login: ${error}`);
		}
	};
			...
			<div className="row justify-content-center">
				<div className="container-fluid">
					<div data-aos="flip-left" data-aos-duration="1000">
						<div
							id="card-login"
							className="col-4 justify-content-center centrar card p-3 mb-5 shadow"
						>
							...
							<form className="">
								...
								<div className="form-group">
									...
									<input
										...
										onChange={evt => this.setState({ upass: evt.target.value })}
										required
									/>
								</div>
								<div className="row justify-content-center">
						...
						<div className="col-4 justify-content-center centrar card p-3 mb-5">
							<div className="card-body">
								...
								<p className="card-text text-center">
									{' '}
									We are here to help you find the best job offers!
								</p>
							</div>
						</div>
					</div>
					...
					<div data-aos="fade-up" data-aos-duration="1000">
						<div className="col-4 justify-content-center centrar card p-3 mb-5">
							<div className="card-body">
								...
								<p className="card-text text-center">
									{' '}
									you have encouterd an easter egg
								</p>
							</div>
						</div>
					</div>
